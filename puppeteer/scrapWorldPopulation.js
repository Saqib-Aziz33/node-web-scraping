 ...
 * scrapes world population data from worldometers site and logs it to the console.
...
/**
 * RUN THIS FUNCTION TO SCRAPE WORLD POPULATION< ONLY ONCE
 */
...
/**
 * SCRAP DATA AFTER EVERY 2 MINTUES
 */
function scheduledScrap() {
